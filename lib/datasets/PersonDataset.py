...
class PersonDataset(Dataset):
    def __init__(self, dataset_name, cfg, period, aug):
        ...
        self.root_dir = os.path.join('/media/home/Workspace/PartSeg/Pascal_person/')
        self.dataset_dir = os.path.join(self.root_dir)
        self.rst_dir = os.path.join(self.root_dir, 'results_release', dataset_name, 'Segmentation')
        ...
        self.ann_dir = os.path.join(self.dataset_dir, 'GT_person/SegmentationPart')
        self.seg_dir = os.path.join(self.dataset_dir, 'GT_person/SegmentationPart')

        ##edge and body loss
        self.edge_dir = os.path.join(self.dataset_dir, 'GT_person/edge')
        self.ins_dir = os.path.join(self.dataset_dir, 'GT_person/instance')
        ...
        if aug:
            ...
            file_name = self.set_dir + '/' + period + 'id.txt'
