...
class Configuration():
	def __init__(self):
		...
		self.EXP_NAME = 'BSANet-person'

		self.DATA_NAME = 'Person'
		self.DATA_AUG = False
		self.DATA_WORKERS = 8
		...
		### Model Path for test 
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'model/BSANet-person/BSANet_res101_atrous_Person_epoch200_all.pth')
