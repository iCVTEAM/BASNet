...
class Configuration():
	def __init__(self):
		...
		self.MODEL_SEMANTIC_CLASSES = 21
		...
		### Model Path for test 
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'model/BSANet-unified/BSANet_res101_atrous_Unified_epoch100_all.pth')
